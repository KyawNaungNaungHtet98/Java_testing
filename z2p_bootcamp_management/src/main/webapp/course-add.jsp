	...
	<div class="container">
		...
		<form action="${save}" class="form col-5 offset-3" method="post">
			...
			<div class="mb-3">
				...
				<input value="${course.name}" type="text" name="name" id = "name" required="required" class="form-control"  placeholder="Enter Course name"/>
			</div>
			<div class="mb-3">
				<label class="form-label">Content</label>
				<textarea class="form-control" id="summernote" name = "outline">${course.contents} </textarea>
			</div>
			<div class="mb-3">
